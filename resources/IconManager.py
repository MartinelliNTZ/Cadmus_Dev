...
class IconManager:
    ...
    # processing
    ATTRIBUTE_STATS = "attribute_statistics.ico"
    FIELD_DIFFERENCE = "difference_fields.ico"
    GEOMETRY_LINE_DIFFERENCE = "geometry_line_from_points.ico"
    ...
    RASTER_OPTIMIZER = "raster_optimizer.ico"
    RASTER_DIFFERENCE_STATISTICS = "raster_difference_statistics.ico"
